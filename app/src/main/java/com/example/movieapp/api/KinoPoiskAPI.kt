...
interface KinoPoiskAPI {
    ...
    @Headers("X-API-KEY: 9dea54ec-4608-424b-98a4-3cd3b76af31e")
    @GET("v2.2/films/{id}")
    suspend fun getMovie(@Path("id") id : Int) : MovieById
    @Headers("X-API-KEY: 9dea54ec-4608-424b-98a4-3cd3b76af31e")
    @GET("v1/staff")
    suspend fun  getStaff(@Query("filmId") movieID : Int) : List<Person>
    @Headers("X-API-KEY: 9dea54ec-4608-424b-98a4-3cd3b76af31e")
    @GET("v1/staff/{id}")
    suspend fun getActorById(@Path("id") actorId : Int) : ActorById
}